...
export default function SpotifyCard({
  ...
  if (compact) {
    return (
      <div className="bg-white rounded-md p-1 flex items-center gap-1.5 shadow-sm">
        {/* Album art / Thumbnail */}
  ...
  return (
    <div className="bg-white rounded-xl p-3 flex items-center gap-3 shadow-sm">
      ...
      <button
        onClick={handlePlay}
        className="px-4 py-1.5 rounded-full text-white text-xs font-medium hover:opacity-90 transition-opacity"
        style={{ backgroundColor: themeColor }}
      >
        Play me
      </button>
